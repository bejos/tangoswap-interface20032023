...
import { ChainId, CurrencyAmount, JSBI, MASTERCHEF_ADDRESS, MASTERCHEF_V2_ADDRESS, Token, ZERO } from '@cryptoscalper/sdk'
...
const FarmListItem = ({ farm }) => {
  ...
  const APPROVAL_ADDRESSES = {
    [Chef.MASTERCHEF]: {
      [ChainId.COREDAO]: MASTERCHEF_ADDRESS[ChainId.COREDAO],
      [ChainId.COREDAO_AMBER]: MASTERCHEF_ADDRESS[ChainId.COREDAO_AMBER],
    },
    [Chef.MASTERCHEF_V2]: {
      [ChainId.COREDAO]: MASTERCHEF_V2_ADDRESS[ChainId.COREDAO]
    },
  }
