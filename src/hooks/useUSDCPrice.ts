...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  // [ChainId.COREDAO]: CurrencyAmount.fromRawAmount(FLEXUSD[ChainId.COREDAO], 100_000e6),
  [ChainId.COREDAO_AMBER]: CurrencyAmount.fromRawAmount(FLEXUSD[ChainId.COREDAO_AMBER], 100_000e6),
}
