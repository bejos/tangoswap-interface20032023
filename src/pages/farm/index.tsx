...
export default function Farm(): JSX.Element {
  ...
  const hardcodedPairs = {
    [ChainId.COREDAO]: {
      "0x7963269e8a854D3F9D98a6cDEa81efFb31B4D1f2": {
        farmId: 0,
        allocPoint: 9999999,
        token0: TANGO[ChainId.COREDAO],
        token1: new Token(ChainId.COREDAO, '0x98Ff640323C059d8C4CB846976973FEEB0E068aA', 18, 'XTANGO', 'TANGObar'),
      },
      ...
      "0x1A2bdFF5bA942bF20f0db7218cdE28D19aC8dD20": {
        farmId: 4,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x98Dd7eC28FB43b3C4c770AE532417015fa939Dd3', 18, 'FLEX', 'FLEX Coin'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x5b860757a77c62Dca833542e8E4650AEE777a08F": {
        farmId: 5,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x5fA664f69c2A4A3ec94FaC3cBf7049BD9CA73129', 18, 'MIST', 'MistToken'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xd12C1De8740406438eb84Dde44cd0839F48211aa": {
        farmId: 6,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x77CB87b57F54667978Eb1B199b28a0db8C8E1c0B', 18, 'EBEN', 'Green Ben'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xa790208A8C49e586a3F2145aD2c9096d6072E1F3": {
        farmId: 7,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0xc8E09AEdB3c949a875e1FD571dC4b3E48FB221f0', 18, 'MILK', 'Milk'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xF463db65674426A58E9C3fE557FaaE338026ef39": {
        farmId: 8,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x675E1d6FcE8C7cC091aED06A68D079489450338a', 18, 'ARG', 'Bitcoin Cash Argentina'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xCFa5B1C5FaBF867842Ac3C25E729Fc3671d27c50": {
        farmId: 9,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0xc70c7718C7f1CCd906534C2c4a76914173EC2c44', 18, 'KTH', 'Knuth'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xf9185C281fE4C8af452244A65cE7317345352942": {
        farmId: 10,
        allocPoint: 1250000,
        token0: new Token(ChainId.COREDAO, '0xe11829a7d5d8806bb36e118461a1012588fafd89', 18, 'SPICE', 'SPICE'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xBe0e246a87a3e9a2D2Db2efD384E0174F13E62b1": {
        farmId: 11,
        allocPoint: 4999999,
        token0: new Token(ChainId.COREDAO, '0x0b00366fBF7037E9d75E4A569ab27dAB84759302', 18, 'LAW', 'LAWTOKEN'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x1946978E39E6105fEb2107D9c01197a962746bf5": {
        farmId: 12,
        allocPoint: 499999,
        token0: new Token(ChainId.COREDAO, '0xff3ed63bf8bc9303ea0a7e1215ba2f82d569799e', 18, 'ORB', 'ORB'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x23e1E177aE511342fFc27F59da57685b3a0413bc": {
        farmId: 13,
        allocPoint: 4999999,
        token0: new Token(ChainId.COREDAO, '0x265bD28d79400D55a1665707Fa14A72978FA6043', 2, 'CATS', 'CashCats'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x5340619781a8963377aFD76A6999edB6437e3B72": {
        farmId: 14,
        allocPoint: 2499999,
        token0: new Token(ChainId.COREDAO, '0x6732E55Ac3ECa734F54C26Bd8DF4eED52Fb79a6E', 2, 'JOY', 'Joystick.club'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x91dde68D0C08e8620d77B8e7F1836aD4ec3CB33c": {
        farmId: 15,
        allocPoint: 2499999,
        token0: new Token(ChainId.COREDAO, '0x7642Df81b5BEAeEb331cc5A104bd13Ba68c34B91', 2, 'CLY', 'Celery'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xa24e2a9a41020bD1EaD472aF07bCc74cd7fB85A4": {
        farmId: 16,
        allocPoint: 499999,
        token0: new Token(ChainId.COREDAO, '0xca0235058985fcc1839e9e37c10900a73c126708', 7, 'DAO', 'DAO'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x0152F077D2808506FbF6B991b48D1e8DDCBF7107": {
        farmId: 17,
        allocPoint: 499999,
        token0: new Token(ChainId.COREDAO, '0x3d13DaFcCA3a188DB340c81414239Bc2be312Ec9', 18, 'AXIEBCH', 'AxieBCH'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x9E59AAc21DaB7C89d0BDA99335386868539Af9B8": {
        farmId: 18,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x0D8b355f9CEDeB612f2df4B39CdD87059A244567', 2, 'CANDYMAN', 'CandyMAN'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xD4625760E0B5D9a0f46cB95dDa9b660fd6Db610A": {
        farmId: 19,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x225FCa2A940cd5B18DFb168cD9B7f921C63d7B6E', 18, 'FIRE', 'Incinerate'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xC28f5F07B733862f021f2266B99F5214c68E95d0": {
        farmId: 20,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x7ebeadb95724a006afaf2f1f051b13f4ebebf711', 2, 'KITTEN', 'CashKitten'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x1CC824B67e694fd5e0cC7D55120355B1AE4B9c50": {
        farmId: 21,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x9192940099fDB2338B928DE2cad9Cd1525fEa881', 18, 'BPAD', 'BCHPad'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xfe323f2898810E6C3c2c5A9E7dF78A116fFAD4fa": {
        farmId: 22,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0xffa2394b61d3de16538a2bbf3491297cc5a7c79a', 18, 'UATX', 'UatX Token'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x365Ec450d670455b336b833Ca363d21b4de3B9E3": {
        farmId: 23,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x4F1480ba79F7477230ec3b2eCc868E8221925072', 18, 'KONRA', 'Konra'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x7FbcD4B5b7838F3C22151d492cB7E30B28dED77a": {
        farmId: 24,
        allocPoint: 999999,
        token0: new Token(ChainId.COREDAO, '0x98Ff640323C059d8C4CB846976973FEEB0E068aA', 18, 'XTANGO', 'TANGObar'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x0152E5F007D85aae58Eb7191Bd484f12F9c13052": {
        farmId: 25,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x49F9ECF126B6dDF51C731614755508A4674bA7eD', 18, 'RMZ', 'Xolos'),
        token1: WBCH[ChainId.COREDAO],
      },
      ...
      "0xfa2A542B0BF8F5e92Af0D1045ebF0abBB0A6C093": {
        farmId: 28,
        allocPoint: 26999999,
        token0: new Token(ChainId.COREDAO, '0x4b85a666dec7c959e88b97814e46113601b07e57', 18, 'GOC', 'GoCrypto'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0x018005da1a5C886Fb48eB18Eda0849a26B99DA80": {
        farmId: 29,
        allocPoint: 0,
        token0: new Token(ChainId.COREDAO, '0x77d4b6e44a53bbda9a1d156b32bb53a2d099e53d', 18, '1BCH', '1BCH'),
        token1: WBCH[ChainId.COREDAO],
      },
      ...
      "0x4509Ff66a56cB1b80a6184DB268AD9dFBB79DD53": {
        farmId: 32,
        allocPoint: 2499999,
        token0: new Token(ChainId.COREDAO, '0xF05bD3d7709980f60CD5206BddFFA8553176dd29', 18, 'SIDX', 'SmartIndex'),
        token1: WBCH[ChainId.COREDAO],
      },
      "0xE7845D6df693BFD1b0b50AB2d17ac06964559c6b": {
        farmId: 33,
        allocPoint: 4999750,
        token0: new Token(ChainId.COREDAO, '0xe1e655be6f50344e6dd708c27bd8d66492d6ecaf', 18, 'LAWUSD', 'lawUSD'),
        token1: TANGO[ChainId.COREDAO],
      },
      ...
      //   token0: new Token(ChainId.COREDAO, '0xaaC82e8931400fb955Bce783A8fD5bcFF99b4317', 18, 'TR1', 'Tango Reduction 1'),
      //   token1: new Token(ChainId.COREDAO, '0x1D35f2Ea7DE9c3996616BAb03FEe7152FdcaACba', 18, 'TR1', 'Tango Reduction 2'),
      // },
      // ---------------------------------------------------------------------------
      ...
      "0xC01FC198B8c69857D112b6dD2BD3f3fb27e01418": {
        farmId: 35,
        allocPoint: 29420639,
        token0: new Token(ChainId.COREDAO, '0xBc2F884680c95A02cea099dA2F524b366d9028Ba', 18, 'BCUSDT', 'BlockNG USDT'),
        token1: TANGO[ChainId.COREDAO],
      },
      "0xf85ABe8c865d2F6478D33C16e53aF8D1f7714dab": {
        farmId: 36,
        allocPoint: 58841278,
        token0: new Token(ChainId.COREDAO, '0xBc7b858B5694D485AD17c89675649cE44De21BEa', 18, 'BCBNB', 'BlockNG BNB'),
        token1: TANGO[ChainId.COREDAO],
      },
      "0xC849ccDA62Af9f638B849f6116e3B0c9A17a637c": {
        farmId: 37,
        allocPoint: 58841278,
        token0: new Token(ChainId.COREDAO, '0xbC7160974318820be438e54439b309921e96B62C', 18, 'BCETH', 'BlockNG ETH'),
        token1: TANGO[ChainId.COREDAO],
      },
      "0x9b10d51f6E4D213a535CA3C87484bcA26A5E8FE7": {
        farmId: 38,
        allocPoint: 29420639,
        token0: new Token(ChainId.COREDAO, '0xBc9bD8DDe6C5a8e1CBE293356E02f5984693b195', 18, 'BCBCH', 'BlockNG BCH'),
        token1: WBCH[ChainId.COREDAO],
      },
    },
    [ChainId.COREDAO_AMBER]: {
      "0x07DE6fc05597E0E4c92C83637A8a0CA411f3a769": {
        farmId: 0,
        allocPoint: 1000,
        token0: WBCH[ChainId.COREDAO_AMBER],
        token1: new Token(ChainId.COREDAO_AMBER, '0xC6F80cF669Ab9e4BE07B78032b4821ed5612A9ce', 18, 'sc', 'testcoin2'),
      },
    }
  };
  ...
  const hardcodedPairs2x = {
    [ChainId.COREDAO]: {
      "0xCFa5B1C5FaBF867842Ac3C25E729Fc3671d27c50": {
        ...
        rewardToken: new Token(ChainId.COREDAO, '0xc70c7718C7f1CCd906534C2c4a76914173EC2c44', 18, 'KTH', 'Knuth'),
      ...
      "0xF463db65674426A58E9C3fE557FaaE338026ef39": {
        ...
        rewardToken: new Token(ChainId.COREDAO, '0x675E1d6FcE8C7cC091aED06A68D079489450338a', 18, 'ARG', 'Bitcoin Cash Argentina'),
      ...
      "0x0152E5F007D85aae58Eb7191Bd484f12F9c13052": {
        ...
        rewardToken: new Token(ChainId.COREDAO, '0x49F9ECF126B6dDF51C731614755508A4674bA7eD', 18, 'RMZ', 'Xolos'),
        rewardPerSecond: "335648148100000"
      },
      "0xD513165b3bbC1Ca812Db7CBB60340DDf74903A1c": {
        farmId: 3,
        allocPoint: 15624,
        token0: new Token(ChainId.COREDAO, '0xF2d4D9c65C2d1080ac9e1895F6a32045741831Cd', 2, 'HONK', 'Honk'),
        token1: WBCH[ChainId.COREDAO],
        rewarderId: "0x3f43FF8eF6715Eb6E76452a9d719f54eFa5372b1",
        rewardToken: new Token(ChainId.COREDAO, '0xF2d4D9c65C2d1080ac9e1895F6a32045741831Cd', 2, 'HONK', 'Honk'),
      ...
      "0x864c0090D955D947D809CF315E17665Bf9e3b6aB": {
        ...
        rewardToken: new Token(ChainId.COREDAO, '0x4b85a666dec7c959e88b97814e46113601b07e57', 18, 'GOC', 'GoCrypto'),
      ...
      "0x9E59AAc21DaB7C89d0BDA99335386868539Af9B8": {
        ...
        rewardToken: new Token(ChainId.COREDAO, '0x0D8b355f9CEDeB612f2df4B39CdD87059A244567', 2, 'CANDYMAN', 'CandyMAN'),
        rewardPerSecond: "01"
      },
      "0x365Ec450d670455b336b833Ca363d21b4de3B9E3": {
        farmId: 6,
        ...
        rewardToken: new Token(ChainId.COREDAO, '0x4F1480ba79F7477230ec3b2eCc868E8221925072', 18, 'KONRA', 'Konra'),
        rewardPerSecond: "000011580000000000"
      },
      "0x5109aABC359c5267B6d470f43414319dd8a3C123": {
        farmId: 7,
        allocPoint: 15624,
        token0: new Token(ChainId.COREDAO, '0x0cb20466c0dd6454acf50ec26f3042ccc6362fa0', 18, 'NARATH', 'Narath'),
        token1: WBCH[ChainId.COREDAO],
        rewarderId: "0x1d42B726E32f41102BC265d8a1cD5a1751e8deD9",
        rewardToken: new Token(ChainId.COREDAO, '0x0cb20466c0dd6454acf50ec26f3042ccc6362fa0', 18, 'NARATH', 'Narath'),
        rewardPerSecond: "925000000000000000000"
      },
      "0x7B545548dabA183Fc779e656da09dF6bD2b94F88": {
        farmId: 8,
        allocPoint: 499998,
        token0: new Token(ChainId.COREDAO, '0x4EA4A00E15B9E8FeE27eB6156a865525083e9F71', 18, 'Martin₿', 'Africa Unite'),
        token1: WBCH[ChainId.COREDAO],
        rewarderId: "0x6C54582E1F7E0602F526267BEB4b073E35eB46a4",
        rewardToken: new Token(ChainId.COREDAO, '0x4EA4A00E15B9E8FeE27eB6156a865525083e9F71', 18, 'Martin₿', 'Africa Unite'),
        rewardPerSecond: "66979000000000000000000"
      },
      "0x2a7c9D8E0E2286A596192C3C16Cc68979D331F29": {
        farmId: 9,
        allocPoint: 62499,
        token0: new Token(ChainId.COREDAO, '0x387122d80A642581E5AD620696a37b98BB9272e7', 18, 'JOOST', 'Joost.energy'),
        token1: WBCH[ChainId.COREDAO],
        rewarderId: "0xA76F4318eDe44a205EAcFB5eF6EaF28b0A83AAb8",
        rewardToken: new Token(ChainId.COREDAO, '0x387122d80A642581E5AD620696a37b98BB9272e7', 18, 'JOOST', 'Joost.energy'),
  ...
  const map = (pool) => {
    ...
    function getRewards() {
      ...
      const defaultReward = {
        token: 'TANGO',
        icon: 'https://raw.githubusercontent.com/tangoswap-cash/assets/master/blockchains/COREDAO/assets/0x73BE9c8Edf5e951c9a0762EA2b1DE8c8F38B5e91/logo.png',
        rewardPerBlock,
      ...
      if (pool.chef === Chef.MASTERCHEF_V2) {
        ...
        const icon = `https://raw.githubusercontent.com/tangoswap-cash/assets/master/blockchains/COREDAO/assets/${getAddress(
